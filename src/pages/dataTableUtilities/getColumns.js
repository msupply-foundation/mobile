...
const PAGE_COLUMN_WIDTHS = {
  ...
  [ROUTES.CUSTOMER_CREDIT_WITH_VACCINES]: [2, 4, 2, 2, 1, 1, 1],
...
const PAGE_COLUMNS = {
  ...
  [MODALS.VACCINATION_HISTORY]: [
    COLUMN_NAMES.ITEM_CODE,
    COLUMN_NAMES.ITEM_NAME,
    COLUMN_NAMES.VACCINATOR,
    COLUMN_NAMES.VACCINE_DATE,
  ],
  ...
  [MODALS.STOCKTAKE_BATCH_EDIT_WITH_VACCINES]: [
    ...
    COLUMN_NAMES.VVM_STATUS,
    COLUMN_NAMES.EDITABLE_EXPIRY_DATE,
    COLUMN_NAMES.SNAPSHOT_DOSES,
    COLUMN_NAMES.COUNTED_DOSES,
    COLUMN_NAMES.BREACH,
    COLUMN_NAMES.DOSES_DIFFERENCE,
  ],
  ...
  [ROUTES.CUSTOMER_CREDIT_WITH_VACCINES]: [
    COLUMN_NAMES.ITEM_CODE,
    COLUMN_NAMES.ITEM_NAME,
    COLUMN_NAMES.AVAILABLE_QUANTITY,
    COLUMN_NAMES.EDITABLE_TOTAL_QUANTITY,
...
const COLUMNS = () => ({
  ...
  [COLUMN_NAMES.DOSES_DIFFERENCE]: {
    type: COLUMN_TYPES.NUMERIC,
    key: COLUMN_KEYS.DOSES_DIFFERENCE,
    title: tableStrings.doses_difference,
    alignText: 'right',
    sortable: true,
    editable: false,
  },
  ...
  [COLUMN_NAMES.SNAPSHOT_DOSES]: {
    type: COLUMN_TYPES.NUMERIC,
    key: COLUMN_KEYS.SNAPSHOT_DOSES,
    title: tableStrings.snapshot_doses,
    alignText: 'right',
    sortable: true,
    editable: false,
  },
  ...
  [COLUMN_NAMES.COUNTED_DOSES]: {
    type: COLUMN_TYPES.EDITABLE_NUMERIC,
    key: COLUMN_KEYS.DOSES,
    title: tableStrings.counted_doses,
    alignText: 'right',
    sortable: true,
    editable: true,
  },
  ...
  [COLUMN_NAMES.VACCINE_DATE]: {
    type: COLUMN_TYPES.STRING,
    key: COLUMN_KEYS.VACCINE_DATE,
    title: tableStrings.vaccine_date,
    alignText: 'center',
    sortable: true,
    editable: false,
  },
