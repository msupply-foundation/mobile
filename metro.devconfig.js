...
// Escape function taken from the MDN documentation:
...
// https://github.com/BabylonJS/BabylonReactNative/blob/f5aa4f4092c4a1cf8135d1add9aa941d9b87ec5a/Apps/Playground/metro.config.js
// NOTE: The Metro bundler does not support symlinks
// (see https://github.com/facebook/metro/issues/1), which NPM uses for local packages.
      ...
      if (itemStat.isSymbolicLink()) {
        ...
        if (linkStat.isDirectory()) {
          ...
          if (fs.existsSync(packagePath)) {
            ...
            // Search for any dev dependencies of the package.
            // They should be excluded from metro so the packages don't get
            // imported twice in the bundle
            Object.keys(packageInfo.devDependencies).forEach(devDependency =>
